...
int CImageProcessorApp::ExitInstance()
{
...
void CImageProcessorApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CImageProcessorApp 사용자 지정 로드/저장 메서드

void CImageProcessorApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CImageProcessorApp::LoadCustomState()
{
}

void CImageProcessorApp::SaveCustomState()
{
}
